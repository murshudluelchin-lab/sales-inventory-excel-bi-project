...
### Demo Preview
![Demo Preview](screenshots/demo/demo-preview.gif)
...
![Project Hub](screenshots/dashboards/project-hub.png)
...
![Data Model Relationships](screenshots/backend/data-model-relationships.png)

### Power Query
Data preparation, shaping, and transformation steps used in the project.

![Power Query Editor](screenshots/backend/power-query-editor.png)

### Power Pivot
Measure creation and model-based calculation layer.

![Power Pivot](screenshots/backend/power-pivot-measures.png)

### DAX Measure Library
Core KPI and analytical measures used across dashboards.

![DAX Measures](screenshots/backend/dax-measure-list.png)
